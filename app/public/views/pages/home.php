...
<!-- Map of the Restaurants Section (Middle Column) -->
<!-- Middle column: embedded Google Map via <iframe> -->
<!-- Middle column: embedded Google Map via <iframe> -->
...
<!-- Hidden JSON with restaurant data -->
<script id="restaurant-data" type="application/json">
  ...
  <div class="container">
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; align-items: start;">
            ...
            <!-- Middle column: embedded Google Map (Dance locations) -->
<div style="text-align: center;">
  <h3>Map of the Dance</h3>
  <!-- Replace the static image with the iframe -->
  <iframe
  ...
  <!-- Keep the Book the Ticket button under the iframe -->
  <a href="/dancePage" style="background-color: #fff; color: #8B0000; padding: 0.5rem 1rem; text-decoration: none; margin-top: 1rem; display: inline-block;">
    Book the Ticket
  </a>
</div>
